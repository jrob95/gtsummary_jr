...
[![R-CMD-check](https://github.com/ddsjoberg/gtsummary/workflows/R-CMD-check/badge.svg)](https://github.com/ddsjoberg/gtsummary/actions) [![CRAN status](https://www.r-pkg.org/badges/version/gtsummary)](https://cran.r-project.org/package=gtsummary) [![Codecov test coverage](https://codecov.io/gh/ddsjoberg/gtsummary/branch/main/graph/badge.svg)](https://app.codecov.io/gh/ddsjoberg/gtsummary?branch=main) [![](https://cranlogs.r-pkg.org/badges/gtsummary)](https://cran.r-project.org/package=gtsummary) [![DOI:10.32614/RJ-2021-053](https://zenodo.org/badge/DOI/10.32614/RJ-2021-053.svg)](https://doi.org/10.32614/RJ-2021-053)
...
```{r table1_print, out.width = "25%", echo = FALSE}

table1_print <- as_gt(table1)%>%
...
```{r table2_print, out.width = "55%", echo = FALSE}

table2_print <- as_gt(table2)%>%
  gt::as_raw_html(inline_css = TRUE)
...
```{r regress_print, out.width = "40%", echo = FALSE}
...
```{r tbl_merge_ex1_print, out.width = "60%", echo = FALSE}

tbl_merge_ex1_print <- as_gt(tbl_merge_ex1)%>%
